...
public class GlobalExceptionHandler {
    ...
    public Mono<ResponseEntity<ErrorResponse>> onNotFound(QuestionNotFoundException ex) {
        ...
        var body = ErrorResponse.builder()
                ...
                .build();
        return Mono.just(ResponseEntity
                .status(HttpStatus.NOT_FOUND).contentType(MediaType.APPLICATION_JSON).body(body));
    }
