...
import com.mercadolibre.camilo.model.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public Mono<ResponseEntity<ErrorResponse>> onNotFound(SellerNotFoundException ex) {
        log.warn("Seller not found: {}", ex.getMessage());
        ErrorResponse body = ErrorResponse.builder()
                .code(ErrorCodes.SELLER_NOT_FOUND)
                .description(ex.getMessage())
    ...
    public Mono<ResponseEntity<ErrorResponse>> onMethodArgInvalid(MethodArgumentNotValidException ex) {
        ...
        log.warn("Method argument not valid: {}", details);
        ErrorResponse body = ErrorResponse.builder()
                .code(ErrorCodes.INVALID_REQUEST)
